<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <form action="{{ $data->id ? route('penjualan.penjualan-langsung.update', $data->id) : route('penjualan.penjualan-langsung.store') }}" method="POST" id="form-action">
            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="scan_qr" autocomplete="off"  placeholder="Sqan QR Code" class="form-control" >
                                    </div>
                                </div>
