<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Detail Penjualan Langsung</h4>
            ...
            <div class="row mt-1">
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-1">:</div>
                        <div class="col-6"><strong>{{$data->nomor}}</strong></div>
                        <div class="col-5">Nama</div>
                        <div class="col-1">:</div>
                        <div class="col-6"><strong>{{$data->karyawan->nama}}</strong></div>
                        <div class="col-5">Divisi</div>
                        <div class="col-1">:</div>
                        <div class="col-6">{{$data->karyawan->divisi}}</div>
                        <div class="col-5">Tanggal Pembelian</div>
                        <div class="col-1">:</div>
                        <div class="col-6">{{$data->tanggal_formatted}}</div>     
                    </div>
                </div>
            </div>
              <div class="row mt-2">
                <div class="col-12 table-responsive">
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            @foreach ($data->penjualanDetail as $item)
                            <tr>
                        ...
                        <tfoot>
                                <tr>
                                    <th colspan="5" rowspan="3" class="border-0 bg-transparent">
                                        @if ($data->voucher->count())
                                        <strong>Note : </strong>
                                        <p class="text-capitalize">
                                            {{$data->voucher->implode('nama', ', ')}}
                                        </p>
                                        @endif
                                    </th>
                                    <th>Total</th>
                    ...
                    <div class="modal-footer">
                        @if ( dateFormat($data->tanggal, 'm') == now()->format('m') && !$data->batal)
                        <a href="{{ route('penjualan.penjualan-langsung.batal', $data->id) }}" data-method="PUT" class="btn btn-danger batal">Batal</a>
                        @endif
