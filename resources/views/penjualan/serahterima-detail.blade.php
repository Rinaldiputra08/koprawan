<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Detail Serah Terima Barang</h4>
        ...
        <div class="modal-body">
            <div class="row mt-1">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-5">Nomor Serah Terima</div>
                        <div class="col-1">:</div>
                        ...
                        <div class="col-5">Tanggal Serah Terima</div>
                        <div class="col-1">:</div>
            ...
            <div class="row mt-2">
                <div class="col-12 table-responsive">
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            @foreach ($data->serahTerimaDetail as $item)
                            <tr>
                    ...
                    <div class="row">
                        <div class="col-md-12 font-small-3 text-right">
