    ...
    <div class="modal-content">
        ...
        <form action="{{ route('pembelian.penerimaan-produk.update', $data->id) }}" id="form-action" method="put">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <h5 class="font-weight-bolder">Nomor : {{ $data->nomor }} / {{ $data->tanggal_penerimaan_formatted }}</h5>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <a href="{{ route('pembelian.penerimaan-produk.batal', $data->id) }}" data-method="PUT" class="btn btn-danger batal">Batal</a>
                @endif
                @if (Route::currentRouteName() == 'pembelian.penerimaan-produk.edit')
