<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">{{ $data->id ? 'Edit Pemesanan' : 'Tambahan Pemesanan' }}</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <form action="{{ $data->id ? route('pembelian.pemesanan-produk.update', $data->id) : route('pembelian.pemesanan-produk.store') }}" method="POST" id="form-action">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="tanggal_pemesanan" value="{{ $data->tanggal_pemesanan }}" readonly class="form-control datepicker">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            <div class="modal-footer justify-content-between">
                <a class="btn btn-secondary referensi-order" href="{{ url('pembelian/pemesanan-produk/cari') }}" data-method="GET">Referensi Pemesanan</a>
