                    ...
                    99 -3 133 -22 195 -26 83 -65 157 -111 210 l-30 35 -1 -137z" />
                        ...
                        <div class="text-center">
                            ...
                            <div class="avatar-content">
                                <img src="{{ asset('storage/images/profile/small_'.auth()->user()->foto) }}" alt="" class="round">
                            </div>
                            <h4 class="card-title">Log off 🔒</h4>
                        </div>
                        <p class="card-text mb-2 mt-2">Masukan password untuk melanjutkan</p>

                        <form class="auth-reset-password-form mt-2" action="{{ route('password.confirm') }}" method="POST">
                            @csrf
                            ...
                            <button class="btn btn-primary btn-block" tabindex="3">{{ __('Login') }}</button>
                        </form>

                        <p class="text-center mt-2">
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}"> <i data-feather="chevron-right"></i> Lupa password?</a>
                            @endif
                        </p>
                    </div>
                </div>
